...
public class JNLPTextureLoader implements ITextureLoader 
{
	...
	public void init()
	{
		...
		textures[IEntity.SPACE_TRASH_1] = loadTexture("src/main/resources/Data/Stage1Layer1.png",256,438,256,256); // Big huge spaceship with 5 reactors
		textures[IEntity.SPACE_TRASH_2] = loadTexture("src/main/resources/Data/Stage1Layer1.png",257,700,256,256);
		textures[IEntity.SPACE_TRASH_3] = loadTexture("src/main/resources/Data/Stage1Layer1.png",373,956,64,64); // Round trash
		textures[IEntity.SPACE_TRASH_4] = loadTexture("src/main/resources/Data/Stage1Layer1.png",492,102,256,128); // Sattelite trash
		...
		animations[IEntity.EXPLOSION2] = loadAnimation("src/main/resources/Data/ExplosionSmall.png",8,4,128,128);
		...
		animations[IEntity.BULLET_HIT_YELLOW] = loadAnimation("src/main/resources/Data/BulletHit.png",4,2,32,32);
		animations[IEntity.BULLET_HIT_GREEN]  = loadAnimation("src/main/resources/Data/BulletHit2.png",4,2,32,32);
		...
		animations[IEntity.BONUS_MULTI_SHOOT_ORB]        = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,00);
		animations[IEntity.BONUS_LIGHTNING_ORB]          = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,64);
		animations[IEntity.BONUS_RAPID_SHOOT_ORB]  = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,128);
		animations[IEntity.BONUS_GRAVITY_ORB]    = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,192);
		animations[IEntity.BONUS_SPEED]       = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,256);
		animations[IEntity.BONUS_CRYSTAL_ORB]= loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,320);
		animations[IEntity.BONUS_BOOSTER] = loadAnimation("src/main/resources/Data/PowerUp1.png",8,1,64,64,00,384);
